...
export const AnnotationToolbar = ({
  ...
  return (
    <TooltipProvider>
      <div className={`annotation-toolbar ${showToolbar ? 'flex flex-col md:flex-row' : 'flex flex-col'} gap-2 bg-gray-800/90 backdrop-blur-sm p-2 rounded-lg shadow-lg transition-all duration-300`}>
        <Tooltip>
