            ...
            <div className="flex flex-col h-full relative">
              ...
              <div className="flex-1 p-2 relative">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 h-full">
                  {/* Local video */}
                  <div 
                    className={`video-container relative aspect-video bg-gray-800 rounded-lg overflow-hidden transition-all duration-500 shadow-lg ring-1 ring-gray-700 ${isSpeaking ? 'speaking-active' : ''}`}
                    style={{
                      backgroundImage: currentBackground.type === 'image' && currentBackground.url ? `url(${currentBackground.url})` : 'none',
                  ...
                  >
                    <video
                      ...
                      style={{
                        ...
                        opacity: currentBackground.type === 'image' ? 0.85 : 1, // Make video slightly transparent when using image background
                      }}
                    />
